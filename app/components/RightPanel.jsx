        ...
        <div className="fixed top-4 right-4 z-50 space-y-2">
          {newCommands.map((cmd, index) => (
            <div
              ...
              className="bg-purple-500 text-white px-4 py-2 rounded-lg shadow-lg border border-purple-600"
            >
              <div className="text-sm font-semibold">Command Created!</div>
              <div className="text-xs">
                <code className="bg-purple-600 px-1 rounded">{cmd.command}</code> - {cmd.slug} ({cmd.count} mentions)
              </div>
            </div>
          ))}
        </div>
